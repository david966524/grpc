...
func (x *greeterSayHelloClientStreamClient) CloseAndRecv() (*HelloReplay, error) {
...
func (x *greeterSayHelloServerStreamClient) Recv() (*HelloReplay, error) {
	m := new(HelloReplay)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *greeterSayHelloTwoWayStreamClient) Recv() (*HelloReplay, error) {
	m := new(HelloReplay)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *greeterSayHelloClientStreamServer) SendAndClose(m *HelloReplay) error {
...
func (x *greeterSayHelloServerStreamServer) Send(m *HelloReplay) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *greeterSayHelloTwoWayStreamServer) Send(m *HelloReplay) error {
	return x.ServerStream.SendMsg(m)
}
